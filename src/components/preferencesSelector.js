...
export default function PreferencesSelector({ setRoundDuration }) {
  ...
  return (
    <div className="md:w-2/3 absolute items-center justify-center flex flex-col gap-4 top-0 left-0 right-0 bottom-1/4 sm:mt-7 animate-jump-in">
      <h2 className="text-xl">
        Select the <br />
        <span className="font-bold text-3xl">Round Duration</span>
      </h2>
      ...
      <form
        ...
        className="flex flex-row py-2 px-4 bg-secondary rounded-lg shadow-lg w-10/12 items-center justify-center"
      >
